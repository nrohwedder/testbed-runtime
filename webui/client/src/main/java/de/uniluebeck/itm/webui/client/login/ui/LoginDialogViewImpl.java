...
import de.uniluebeck.itm.webui.client.login.presenter.LoginDialogPresenter.AuthenticationState;
import de.uniluebeck.itm.webui.client.login.presenter.LoginDialogPresenter.UrnPrefixInfo;
import de.uniluebeck.itm.webui.client.util.HasWidgetsDialogBox;
