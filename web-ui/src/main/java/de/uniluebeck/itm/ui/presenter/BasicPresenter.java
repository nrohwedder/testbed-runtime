...
import de.uniluebeck.itm.events.PresenterRevealedEvent;
import de.uniluebeck.itm.events.PresenterChangedEvent;
 ...
 * @author soenke
 */
public abstract class BasicPresenter<D extends Presenter.Display> implements Presenter {
