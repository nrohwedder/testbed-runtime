...
public class PresenterRevealedEvent extends VaadinEvent<PresenterRevealedHandler> {
    ...
    private static final VaadinEvent.Type<PresenterRevealedHandler> TYPE = new VaadinEvent.Type<PresenterRevealedHandler>();

    public static VaadinEvent.Type<PresenterRevealedHandler> getType() {
        return TYPE;
    }
